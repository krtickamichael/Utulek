    ...
    <div class="content">
        <div class="card_content">
            ...
            ?>
                    ...
                    <div class="card">
                        <img src="<?php echo htmlspecialchars($row->img_dog) ?>" class="img-fluid" name="card_img">
                        <div class=" card-body">
                            <h3 class="card-title">
                        ...
                        <?php if (isset($_SESSION["user_id"])) { ?>
                            <div class="card_delete_btn">
                                <a href="delete_card.php?id=<?php echo htmlspecialchars($row->id_dog); ?>&return_url=<?php echo urlencode('dog.php'); ?>" style="color: rgb(239, 214, 191);" class="bi bi-x-square" onclick="return confirm('Opravdu chcete smazat tohoto psa?');"></a>
                            </div>
                        <?php } ?>
                    </div>
            <?php
                        ...
                        <div class="modal-body">
                            <form action="add_dog.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="dog_img">Dog picture:</label>
                                    <input type="file" class="form-control" id="dog_img_input" name="dog_img" accept="image/*">
                                </div>
                                <div class="form-group">
                                    <label for="name_dog">Dog name:</label>
                                    <input type="text" class="form-control" id="name_dog" name="name_dog" required>
                                </div>
                                <div class="form-group">
                                    <label for="sex_dog">Dog sex:</label>
                                    <select class="form-control" id="sex_dog" name="sex_dog" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="age_dog" name="age_dog" required>
                                </div>
                                <div class="form-group">
                                    <label for="size_dog">Dog size:</label>
                                    <select class="form-control" id="size_dog" name="size_dog" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="breed_dog" name="breed_dog" required>
                                </div>
                                <div class="form-group">
